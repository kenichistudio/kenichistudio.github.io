...
export const CanvasWorkspace = forwardRef<HTMLCanvasElement>((props, ref) => {
    return (
        <div className="flex-1 flex items-center justify-center overflow-hidden min-w-0 min-h-0 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] dark:bg-[radial-gradient(#1e293b_1px,transparent_1px)] [background-size:20px_20px] p-8">
